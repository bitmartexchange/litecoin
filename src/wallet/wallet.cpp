...
void CWallet::BitmartAvailableCoins(std::vector<COutput> &vCoins, bool fOnlySafe, const CCoinControl *coinControl, const CAmount &nMinimumAmount, const CAmount &nMaximumAmount, const CAmount &nMinimumSumAmount, const uint64_t nMaximumCount, const int nMinDepth, const int nMaxDepth) const
{
    vCoins.clear();
...
bool CWallet::FundTransaction(CMutableTransaction& tx, CAmount& nFeeRet, int& nChangePosInOut, std::string& strFailReason, bool lockUnspents, const std::set<int>& setSubtractFeeFromOutputs, CCoinControl coinControl)
{
    ...
    CWalletTx wtx;
    if (!BitmartCreateTransaction(vecSend, wtx, reservekey, nFeeRet, nChangePosInOut, strFailReason, coinControl, false)) {
        return false;
    }
...
bool CWallet::BitmartCreateTransaction(const std::vector<CRecipient>& vecSend, CWalletTx& wtxNew, CReserveKey& reservekey, CAmount& nFeeRet,
                                int& nChangePosInOut, std::string& strFailReason, const CCoinControl& coin_control, bool sign)
{
    ...
    unsigned int nBytes;
    {
        ...
        LOCK2(cs_main, cs_wallet);
        {
            ...
            BitmartAvailableCoins(vAvailableCoins, true, &coin_control);
            ...
            while (true)
            {
                ...
                if (!BitmartDummySignTx(txNew, setCoins)) {
                    strFailReason = _("DummySign Signing transaction failed");
                    return false;
                }
        ...
        if (sign)
        {
            ...
            for (const auto& coin : setCoins)
            {
                ...
                {
                    strFailReason = _("ProduceSign Signing transaction failed");
                    return false;
                } else {
